...
const SolutionSection = () => {
  ...
  return <SectionWrapper id="solution" backgroundColor="bg-nipay-green" className="text-white py-16 md:py-24">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-12">
        <IconCard icon={<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              ...
              <path d="M12 17h.01" />
              <path d="M17 17h.01" />
            </svg>} title="Apply in Minutes" description="Simple mobile app setup." className="text-white" />
        
        <IconCard icon={<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
              <path d="M12 2v20" />
              <path d="m4.93 15.93 14.14-14.14" />
              <path d="m19.07 15.93-14.14-14.14" />
            </svg>} title="Funds Within Hours" description="Same-day limit access." className="text-white" />
        ...
        <IconCard icon={<svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            ...
            </svg>} title="Flexible Repayments" description="Auto-repay from income." className="text-white" />
      </div>
