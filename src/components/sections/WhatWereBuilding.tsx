...
const WhatWereBuilding = () => {
  ...
  return (
    <SectionWrapper backgroundColor="bg-gray-50" className="py-16 lg:py-18">
      <div className="max-w-4xl mx-auto">
        <h2 className="text-2xl lg:text-3xl font-bold text-center mb-3 text-nipay-dark-green">
          What We're Building
        </h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {features.map((feature, index) => (
            <div key={index} className="bg-white rounded-xl p-6 text-center shadow-md hover:shadow-lg transition-all duration-300 border border-gray-100">
              ...
              <h3 className="text-base font-bold mb-3 text-nipay-dark-green">{feature.title}</h3>
