      ...
      <div className="container mx-auto py-10 md:py-12 px-4">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="mb-4 md:mb-6 max-w-md text-sm md:text-base">Rwanda's #1 mobile money loan platform. Get instant business loans from your mobile money sales. No paperwork, no collateral needed.</p>
            <div className="flex space-x-4">
              <a href="#" className="hover:text-nipay-green transition-colors" aria-label="LinkedIn">
              ...
              <a href="#" className="hover:text-nipay-green transition-colors" aria-label="Twitter">
                <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-twitter">
                  <path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path>
                </svg>
              </a>
              <a href="mailto:contact@nipay.rw" className="hover:text-nipay-green transition-colors" aria-label="Email">
